export const DEFAULT_COUNTRY_LIST = [
  { code: 'SA', name: 'KSA', aliases: ['Saudi Arabia', 'SA'], flag: '🇸🇦', dial: '+966', currency: 'SAR', currencySymbol: '﷼', domain: 'ar.buysial.com', hreflang: 'ar-SA', locale: 'ar_SA', enabled: true, order: 1 },
  { code: 'AE', name: 'UAE', aliases: ['United Arab Emirates'], flag: '🇦🇪', dial: '+971', currency: 'AED', currencySymbol: 'د.إ', domain: 'ae.buysial.com', hreflang: 'ar-AE', locale: 'ar_AE', enabled: true, order: 2 },
  { code: 'OM', name: 'Oman', aliases: [], flag: '🇴🇲', dial: '+968', currency: 'OMR', currencySymbol: 'ر.ع.', domain: 'om.buysial.com', hreflang: 'ar-OM', locale: 'ar_OM', enabled: true, order: 3 },
  { code: 'BH', name: 'Bahrain', aliases: [], flag: '🇧🇭', dial: '+973', currency: 'BHD', currencySymbol: 'د.ب', domain: 'bh.buysial.com', hreflang: 'ar-BH', locale: 'ar_BH', enabled: true, order: 4 },
  { code: 'KW', name: 'Kuwait', aliases: [], flag: '🇰🇼', dial: '+965', currency: 'KWD', currencySymbol: 'KD', domain: 'kw.buysial.com', hreflang: 'ar-KW', locale: 'ar_KW', enabled: true, order: 5 },
  { code: 'QA', name: 'Qatar', aliases: [], flag: '🇶🇦', dial: '+974', currency: 'QAR', currencySymbol: 'ر.ق', domain: 'qa.buysial.com', hreflang: 'ar-QA', locale: 'ar_QA', enabled: true, order: 6 },
  { code: 'IN', name: 'India', aliases: [], flag: '🇮🇳', dial: '+91', currency: 'INR', currencySymbol: '₹', domain: 'in.buysial.com', hreflang: 'en-IN', locale: 'en_IN', enabled: true, order: 7 },
  { code: 'PK', name: 'Pakistan', aliases: [], flag: '🇵🇰', dial: '+92', currency: 'PKR', currencySymbol: 'Rs', domain: 'pk.buysial.com', hreflang: 'ur-PK', locale: 'ur_PK', enabled: true, order: 8 },
  { code: 'JO', name: 'Jordan', aliases: [], flag: '🇯🇴', dial: '+962', currency: 'JOD', currencySymbol: 'د.ا', domain: 'jo.buysial.com', hreflang: 'ar-JO', locale: 'ar_JO', enabled: true, order: 9 },
  { code: 'US', name: 'USA', aliases: ['United States', 'United States of America'], flag: '🇺🇸', dial: '+1', currency: 'USD', currencySymbol: '$', domain: 'us.buysial.com', hreflang: 'en-US', locale: 'en_US', enabled: true, order: 10 },
  { code: 'GB', name: 'UK', aliases: ['United Kingdom'], flag: '🇬🇧', dial: '+44', currency: 'GBP', currencySymbol: '£', domain: 'uk.buysial.com', hreflang: 'en-GB', locale: 'en_GB', enabled: true, order: 11 },
  { code: 'CA', name: 'Canada', aliases: [], flag: '🇨🇦', dial: '+1', currency: 'CAD', currencySymbol: 'C$', domain: 'ca.buysial.com', hreflang: 'en-CA', locale: 'en_CA', enabled: true, order: 12 },
  { code: 'AU', name: 'Australia', aliases: [], flag: '🇦🇺', dial: '+61', currency: 'AUD', currencySymbol: 'A$', domain: 'au.buysial.com', hreflang: 'en-AU', locale: 'en_AU', enabled: true, order: 13 },
]
