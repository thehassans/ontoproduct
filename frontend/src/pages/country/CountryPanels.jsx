...
export default function CountryPanels() {
  ...
  // Get current host strictly avoiding subdomain for the base link
    ...
    <div style={{ maxWidth: 1200, margin: '0 auto', padding: '30px 20px', fontFamily: 'Inter, sans-serif' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 15, marginBottom: 30 }}>
        ...
        <div>
          ...
          <p style={{ margin: '4px 0 0', fontSize: 14, color: '#666' }}>Direct access to isolated regional panels for staff and agents.</p>
        </div>
      </div>

      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: 20 }}>
        {AVAILABLE_COUNTRIES.map(country => {
          // e.g. https://pk.buysial.com/login
