        ...
        <form onSubmit={onSubmit} className="section" style={{display:'grid', gap:12}}>
          ...
          <div className="form-grid">
            <div>
              ...
              <div className={`helper-text ${phoneError? 'error':''}`}>{phoneError || 'Only UAE, Oman, KSA, Bahrain, Kuwait, Qatar, India, Pakistan, Jordan, USA, UK, Canada or Australia numbers allowed'}</div>
            </div>
            <div>
