      ...
      <div className="pf2-payments">
        ...
        <div className="pf2-payments-inner">
          ...
          <div className="pf2-pay-badge pf2-pay-dark">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 21" style={{width:50,height:21}}>
              <path d="M9.6 2.513A3.98 3.98 0 0 0 10.51.1a4.08 4.08 0 0 0-2.65 1.37 3.82 3.82 0 0 0-.96 2.32 3.38 3.38 0 0 0 2.7-1.277zm.88 1.5c-1.49-.09-2.76.85-3.47.85s-1.8-.8-2.97-.78A4.39 4.39 0 0 0 .32 6.533c-1.59 2.75-.41 6.82 1.13 9.07.76 1.1 1.67 2.34 2.86 2.3 1.15-.05 1.58-.74 2.97-.74s1.78.74 2.99.71c1.24-.02 2.02-1.13 2.78-2.24a10.01 10.01 0 0 0 1.26-2.56 3.97 3.97 0 0 1-2.38-3.64 4.06 4.06 0 0 1 1.93-3.41 4.15 4.15 0 0 0-3.37-1.66zm10.17-.57h4.74c3.27 0 5.48 2.26 5.48 5.56s-2.25 5.58-5.55 5.58h-3.1v5.78h-1.57zm1.57 9.58h2.91c2.28 0 3.57-1.22 3.57-3.78s-1.29-3.76-3.56-3.76H22.22zm11.74 1.04c0-2.21 1.69-3.56 4.7-3.73l3.46-.2v-.97c0-1.41-.95-2.26-2.55-2.26-1.35 0-2.31.67-2.52 1.74h-1.47c.1-1.88 1.72-3.31 4.24-3.31 2.5 0 4.13 1.32 4.13 3.37v7.02h-1.65v-1.68h-.04a3.81 3.81 0 0 1-3.4 1.89c-2.11 0-3.66-1.3-3.66-2.87zm8.16-.88v-.99l-3.11.2c-1.55.1-2.43.75-2.43 1.76 0 1.01.91 1.67 2.29 1.67 1.8 0 3.25-1.2 3.25-2.64zm4.37 6.57v-1.39c.13.04.43.04.56.04.82 0 1.27-.35 1.54-1.24l.16-.55-3.98-11.01h1.87l3.01 9.57h.04l3.02-9.57h1.82l-4.13 11.46c-.94 2.65-2.04 3.5-4.33 3.5-.13 0-.44-.02-.58-.05z" fill="#fff"/>
            </svg>
          </div>
          {/* Google Pay */}
          <div className="pf2-pay-badge">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56 24" style={{width:52,height:22}}>
              <path d="M26.87 11.76V17.5h-1.77V3.5h4.7a4.26 4.26 0 0 1 3.04 1.17 3.86 3.86 0 0 1 1.26 2.9 3.81 3.81 0 0 1-1.26 2.89 4.23 4.23 0 0 1-3.04 1.17zm0-6.56v5.57h2.98a2.41 2.41 0 0 0 1.81-.74 2.48 2.48 0 0 0 0-3.58 2.42 2.42 0 0 0-1.81-.74h-2.98z" fill="#3C4043"/>
              <path d="M38.46 8.24a4.25 4.25 0 0 1 3 1.07 3.89 3.89 0 0 1 1.15 2.98v5.21h-1.7v-1.17h-.08a3.38 3.38 0 0 1-2.9 1.5 3.78 3.78 0 0 1-2.6-.96 3.04 3.04 0 0 1-1.08-2.37 2.87 2.87 0 0 1 1.14-2.38 4.63 4.63 0 0 1 2.96-.89 5.15 5.15 0 0 1 2.49.52v-.37a2.12 2.12 0 0 0-.78-1.68 2.63 2.63 0 0 0-1.78-.69 2.78 2.78 0 0 0-2.38 1.32l-1.56-.98a4.45 4.45 0 0 1 3.67-1.55zm-2.19 7.99a1.43 1.43 0 0 0 .63 1.2 2.22 2.22 0 0 0 1.39.47 2.94 2.94 0 0 0 2.08-.87 2.78 2.78 0 0 0 .91-2.04 3.6 3.6 0 0 0-2.22-.6 3.04 3.04 0 0 0-1.82.53 1.63 1.63 0 0 0-.74 1.31h-.23z" fill="#3C4043"/>
              <path d="M49.78 8.57l-5.94 13.66h-1.83l2.21-4.78-3.91-8.88h1.93l2.85 6.86h.03l2.77-6.86z" fill="#3C4043"/>
              <path d="M21.28 10.95a8.5 8.5 0 0 0-.1-1.19h-7.01v2.24h4a3.42 3.42 0 0 1-1.49 2.25v1.86h2.41a7.27 7.27 0 0 0 2.22-5.16h-.03z" fill="#4285F4"/>
              <path d="M14.17 15.96c2.02 0 3.71-.67 4.94-1.81l-2.41-1.86a4.51 4.51 0 0 1-6.72-2.37H7.5v1.93a7.46 7.46 0 0 0 6.68 4.11z" fill="#34A853"/>
              <path d="M9.98 9.92a4.46 4.46 0 0 1 0-2.87V5.12H7.5a7.49 7.49 0 0 0 0 6.7z" fill="#FBBC04"/>
              <path d="M14.17 5.04a4.04 4.04 0 0 1 2.87 1.12l2.15-2.15A7.22 7.22 0 0 0 14.17 2a7.46 7.46 0 0 0-6.68 4.11l2.49 1.93a4.46 4.46 0 0 1 4.19-3z" fill="#EA4335"/>
            </svg>
          </div>
        </div>
      </div>
